...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "TraceIMEI-BJ — Plateforme de traçabilité des téléphones au Bénin" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "TraceIMEI-BJ — Tracez. Protégez. Vérifiez." },
      { property: "og:description", content: "Première plateforme ML de traçabilité des téléphones volés au Bénin." },
